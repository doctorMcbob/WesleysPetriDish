...
from pysrc import frames
from pysrc import cubes
from pysrc import inputs
from pysrc.automata import RULES
...
def process():
    global MPOS, FONT, AXIS1, AXIS2, INDEX, RELATIVE_POSITION, PW, show_log
